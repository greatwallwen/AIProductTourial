...
第一部分讲的理念、原理、规范、设计，不是散点——它们共同构成**一套数字化系统**。下面 17 个代表性案例，正是这套系统在不同环节、不同层的**实操演示**（每案标注它更偏哪个角色镜头）：
...
| 51 | 规格驱动系统建造台 | 研发效能 / 架构 | 研发/项目/产品 | 3.0/2.3/6.4 | cyan-matrix | [打开](51-sdd_system_build.md) |
| 52 | 架构决策模拟器 | 研发效能 / 架构 | 研发/项目 | 3.1/3.4/4.7 | steel-queue | [打开](52-arch_decision_sim.md) |
| 53 | 规格找漏洞闯关 | AI 产品 / 需求 | 产品/研发 | 3.0/3.2 | cyan-matrix | [打开](53-spec_flaw_hunt.md) |
...
| §2.3 | [案例 48](48-ci_triage_loop.md)、[案例 50](50-delivery_gates_board.md)、[案例 51](51-sdd_system_build.md) |
...
| §3.0 | [案例 51](51-sdd_system_build.md)、[案例 53](53-spec_flaw_hunt.md) |
| §3.1 | [案例 41](41-retail_capstone_board.md)、[案例 46](46-system_arch_flow.md)、[案例 52](52-arch_decision_sim.md) |
| §3.2 | [案例 16](16-hospital_capacity_scheduler.md)、[案例 30](30-airline_member_rfm.md)、[案例 31](31-ad_conversion_funnel.md)、[案例 53](53-spec_flaw_hunt.md) |
...
| §3.4 | [案例 14](14-logistics_change_control.md)、[案例 52](52-arch_decision_sim.md) |
...
| §4.7 | [案例 52](52-arch_decision_sim.md) |
| §5.1 | [案例 47](47-three_d_scatter.md) |
| §6.4 | [案例 51](51-sdd_system_build.md) |
