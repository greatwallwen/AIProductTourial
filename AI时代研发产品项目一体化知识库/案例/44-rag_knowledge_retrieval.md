...
交付物：**RAG 检索方案与验收**。必含要素（字段/指标链/异常状态/Skill/决策动作/高影响复核）与合格线由自测器六项核对：`node code/tools/check_my_work.mjs 44 你的方案.md`；红线：不越过「不得把低相似片段当作事实回答」。
...
4. **自测产出**：`node code/tools/check_my_work.mjs 44 你的方案.md`——红项指明缺什么、回哪章补。
...
- 答不顺就回读本案演示的原理小节 §1.3、§3.3；写成方案后跑 `node code/tools/check_my_work.mjs 44 你的方案.md`，红项会指明缺什么、回哪章补。
</details>
