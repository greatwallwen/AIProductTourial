...
- [已立] ① 宪法 / rules/ai-dev-constraints.md / 已立 → 责任 研发-王（演示角色）
- [已写] ② 规格 / docs/_source/*.md / 已写 → 责任 产品-王（演示角色）
- [人工] ③ 澄清 / （人在关口） / 人工 → 责任 项目-孙（演示角色）
- [已画] ④ 架构设计 / arch SVG + §3 ADR / 已画 → 责任 研发-王（演示角色）
- [已分] ⑤ 任务分解 / case_definitions.json / 已分 → 责任 产品-王（演示角色）
- [已建] ⑥ 实现 / code/ 全栈 / 已建 → 责任 项目-孙（演示角色）
