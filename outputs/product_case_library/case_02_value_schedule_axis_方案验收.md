...
**PASS** — 指标链 5 项均为回到 `dataset/product_cases/aicourse_hr_employees.csv` 的真实计算值；字段/异常/Skill 齐备；可运行原型见 `#/case/02`（设计 cyan-matrix），截图 `assets/screenshots/premium_case_02_value_schedule_axis_desktop.png`。
