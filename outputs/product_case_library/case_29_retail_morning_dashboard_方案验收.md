...
**PASS** — 指标链 5 项均为回到 `dataset/order_data.csv` 的真实计算值；字段/异常/Skill 齐备；可运行原型见 `#/case/29`（设计 graphite-hud），截图 `assets/screenshots/premium_case_29_retail_morning_dashboard_desktop.png`。
