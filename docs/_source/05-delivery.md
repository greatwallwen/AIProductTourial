...
```备注
本书做的事——给 AI 工作流装传感器、门禁、停机规则、回归基线——2026 年被命名为 **Harness Engineering（挽具工程）**，与 Spec Engineering 并列 AI 原生开发两大支柱（源：awesome-harness-engineering；Mahajan，2026-03；核实 2026-07）。名字是新的，内容你已会：§2 传感器 + 本章三绿 + 案例 49 回归门 + 案例 51 活体门禁 = 一套完整 harness。
```
