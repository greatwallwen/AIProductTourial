...
| RAG / Embedding / 向量 | 案例 44 语义检索、案例 45 关系库底座、案例 49 RAG 评测台 |
| Agent / ReAct（§1.6） | §2 三层 Loop 的「执行器」；`#/lab/agent` ReAct 小游戏、案例 51 逐任务 maker/checker Loop |
| eval / 评测 | §2「传感器就是设计本身」、§5 门禁三绿；案例 49 评测台、案例 51 门禁走查 |
