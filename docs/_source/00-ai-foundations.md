...
| eval / 评测 | §2「传感器就是设计本身」、§5 门禁三绿；案例 49 评测台、案例 50 交付门禁 |
| 幻觉 / hallucination | 案例 44 用检索压幻觉；§5 高影响域保留人工复核 |
