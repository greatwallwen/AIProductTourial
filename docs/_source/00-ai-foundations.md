...
![AI 核心概念底层链路（image2 概念原型，非运行证据）](assets/image2/foundation-ai-stack-image2.png)
...
![RAG 知识检索工作台（image2 产品原型，指标以实际运行回执为准）](assets/image2/rag-knowledge-console-image2.png)
...
![Agent 执行、开发判断与真实用户三层 Loop（image2 概念原型，非运行证据）](assets/image2/loop-three-layers-image2.png)
