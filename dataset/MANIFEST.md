...
| rag/gold.json | 60 | 真实基座派生（webMedQA 中文医疗问答 60 题金标；docPattern 匹配正确答案篇 dataset/rag/corpus/med_c*.md；answer-selection 原生金标） | a1d8a3c16aa841b0… |
...
| dataset/real/renrendai_p2p.csv | [人人贷 P2P 借贷记录（Harvard Dataverse doi:10.7910/DVN/C4RUDY·中国大陆）](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/C4RUDY) | CC0-1.0 | 案例 02 大陆 P2P 信贷·新客vs复借·信用画像分层 | a2d1b494bf45b06b… |
