...
| S05 雨天旧书店海报 | 三套方向均可比较，选中“雨夜橱窗”；本地 SVG 可编辑；没有冒充图像 Provider 结果 | [9 个文件](../S05/runtime-receipt.json) |
| S06 Markdown 到可编辑演示文稿 | @oai/artifact-tool 生成 5 页可编辑 PPTX；5 张 1280×720 渲染图已检查；边界、重叠、溢出、空白页与备注检查全部通过 | [250 个文件](../S06/runtime-receipt.json) |
...
- Skill 合同校验：8/8 通过。
- Python / Node / Artifact Tool 聚焦测试：36/36 通过。
