...
| 文件 | 说明 |
|---|---|
| `assets/diagrams/B20-c4.drawio` | 4 页 drawio 源文件，可用 draw.io desktop / diagrams.net 打开编辑 |
| `assets/diagrams/B20-c4-layer-L1.svg` | L1 系统上下文：性能工程师 / 运维主管 / 核查台 / 公开数据集 / 调度系统 |
| `assets/diagrams/B20-c4-layer-L2.svg` | L2 容器：Next.js 工作台 / 类型化命令服务 / 事件记录 / 站日事实存储 |
| `assets/diagrams/B20-c4-layer-L3.svg` | L3 组件：事实/线索/缺失/任务/趋势/站点选择六面板 |
| `assets/diagrams/B20-c4-layer-L4.svg` | L4 代码：PvLossWorkbench / restoreTask / runCommand / trendSegments / domain-command |
