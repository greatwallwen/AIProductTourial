...
CASES = [
    ("B001", "大额取消单核验", "售后专员", "选择取消发票", "核对原单、付款与商品关系", "补证或提交独立复核", "复核人 / 主管", "取消单 CSV", "退货证据核验台", "补证·复核·暂缓", "材料齐全且角色分离", "案卷事件与状态投影"),
    ("B002", "8 元券首批试投", "会员运营", "筛选成长分层", "稳定抽样并核算人民币预算", "保存 240/60 分组方案", "运营主管", "会员行为 CSV", "优惠券试投台", "保存·确认·退回", "同种子同名单且组间不重叠", "试投方案与版本"),
    ("B003", "餐饮评论调查", "餐饮运营", "选择一个评论主题", "对照支持与反向原话", "建立小样本调查任务", "门店主管", "中文评论 CSV", "顾客评论调查台", "建任务·安排·暂不安排", "原话可追溯且不生成门店事实", "调查任务与引用"),
    ("B004", "金融材料补正", "客户经理", "选择匿名申请", "确认真实缺失材料", "登记回传并换人复核", "材料复核员", "申请与材料 CSV", "申请材料复核台", "补件·回传·双岗复核", "补件人和复核人不能相同", "申请事件与材料状态"),
    ("B005", "医院转运更正", "转运协调员", "定位晚到事件", "比较发生时间与接收时间", "追加更正并重新会签", "护士长 / 信息科", "脱敏事件 CSV", "转运交接协调台", "确认·会签·重开", "事件只追加不覆盖且无临床决定", "事件流与会签状态"),
    ("B006", "空气质量摘录", "数据发布员", "选择站点小时记录", "核对六项污染物与缺失", "冻结摘录范围或退回", "数据复核员", "空气质量 CSV", "历史数据摘录台", "冻结·发布·退回", "全空记录不得伪装为零", "摘录版本与复核记录"),
    ("B007", "即时零售履约调查", "架构负责人", "选择场站日期", "并排查看四域 P95 与事件", "记录假设并决定是否改架构", "技术负责人", "订单与运营证据", "履约架构调查台", "保存观察·提交决定", "同窗相关不等于调用因果", "观察、假设与决定"),
    ("B008", "养殖数值冲突", "水产调度员", "选择冲突测点", "对照系统值、现场值与时间", "派发取证并等待主管采信", "现场人员 / 主管", "水质与取证记录", "数值冲突调查台", "派发·回传·采信", "冲突值并存且来源可追溯", "调查事件与采信状态"),
    ("B009", "地铁断档调查", "可靠性工程师", "选择五分钟窗口", "复算样本数与最大间隔", "补记录或提交目视检查", "设备主管", "MetroPT-3 切片", "断档检查申请台", "补记录·提交·确认", "间隔达 120 秒即拒绝提交", "检查申请与审批事件"),
    ("B010", "通信请求中断恢复", "客诉协调员", "选择中断任务", "核对是否发送与外部结果", "查询状态后决定是否重试", "班组主管", "匿名任务 CSV", "请求恢复协调台", "查询·重试·关闭", "外部结果未知时不得重复提交", "幂等记录与任务状态"),
    ("B011", "模型发布补测", "模型发布经理", "选择候选版本", "比较总体与地区切片", "创建补测并双人确认", "独立评测人", "模型评测快照", "模型准入复核台", "补测·签署·确认", "差异、阈值与签署人都要核对", "准入状态与签署记录"),
    ("B012", "冷链材料补齐", "冷链调查员", "选择运输路线", "核对越界记录与交接材料", "补证后重开调查", "冷链主管", "运输温度 CSV", "冷链调查台", "补材料·重开·复核", "温度越界不能推出产品可用性", "调查单与材料状态"),
    ("B013", "制动异响安全分流", "服务顾问", "打开代表进线", "逐题记录能否移动等回答", "补问或转技师安全复核", "技师主管", "中国进线合成表", "售后安全分流台", "保存·补问·转交", "缺回答保留且不生成故障诊断", "问答事实单与交接"),
    ("B014", "浮选高硅调查", "工艺工程师", "选择连续事件窗", "比较槽列与过程字段", "保存核查任务与暂定方向", "工艺主管", "浮选过程 CSV", "高硅调查台", "建任务·回传·确认", "只记录相关线索不写根因", "核查任务与版本"),
    ("B015", "晶圆复测申请", "质量工程师", "选择未通过样本", "核对缺失通道与排名", "限定复测范围并签署", "质量主管", "SECOM 匿名信号", "晶圆复测申请台", "申请·签署·确认", "缺通道不得按零值处理", "复测申请与审批"),
    ("B016", "风机持续下偏检查", "风机运维工程师", "选择 T007 七日窗", "核对风速、功率与有效记录", "申请现场资料并确认收件", "运维主管", "风机日记录 CSV", "风机核查台", "申请·回传·收件", "日级标记不是故障概率", "核查任务与资料状态"),
    ("B017", "切刀波形排检", "设备工程师", "选择 BD-0003", "比较三路波形与缺失口径", "列入候选或继续补资料", "设备主管", "波形与候选队列", "切刀排检台", "建候选·补资料·确认", "三路齐全不等于故障已确认", "排检候选与审批"),
    ("B018", "锅炉主汽低温调查", "值班运行员", "选择 BT-0044 事件", "定位 24 分钟事件与分段", "下发人工检查并记录回传", "值长", "锅炉分钟窗口", "主汽温度调查台", "建检查·下发·回传", "曲线不能直接归因阀门或过热器", "检查任务与事件记录"),
    ("B019", "液压状态复查", "液压维护工程师", "选择第 217 循环", "并排比较三项同级指标", "排列检查顺序并确认", "维护主管", "液压循环 CSV", "液压状态复查台", "排顺序·提交·确认", "同级指标必须说明排序依据", "检查顺序与版本"),
    ("B020", "光伏少发线索核查", "站端工程师", "选择 PV-08 站日", "区分事实、线索与缺记录", "申请站端资料并确认方向", "区域主管", "光伏站日 CSV", "少发线索核查台", "申请·提交·确认", "派生线索不能写成发电损失", "核查任务与方向"),
    ("B021", "上海周末路线编排", "路线策划", "选择四个真实 POI", "核对门票预算与预约条件", "保存两日路线并交付核验", "业务主管", "上海 POI 历史快照", "周末路线编排台", "保存路线·核验·确认", "交通为课程估算且实时信息必须复核", "路线版本与核验项"),
    ("B022", "调剂信息新鲜度核验", "信息核验员", "筛选历史调剂通知", "回查院校官网与发布日期", "建立官方回源清单", "业务主管", "2021 调剂历史快照", "调剂信息核验台", "加入清单·回源·确认", "历史记录不得表示当前仍有名额", "核验清单与来源状态"),
    ("B023", "春节档排片沙盘", "影院经理", "选择影片与历史排片", "比较片长、受众与影厅时隙", "保存下一轮模拟排片", "业务主管", "春节档历史经营快照", "春节档排片沙盘", "保存草案·审核·确认", "历史经营数据不得冒充实时售票数据", "排片草案与审核版本"),
    ("B024", "连锁门店补货排序", "补货计划员", "选择门店与商品品类", "按历史销量排列核对顺序", "创建库存核对任务", "业务主管", "成都门店交易快照", "门店补货排序台", "建核对·补资料·确认", "没有在库、在途和容量就不生成补货量", "核对任务与确认状态"),
]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build editable Chinese requirement and architecture diagrams for B001-B024")
