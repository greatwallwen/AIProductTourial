...
describe('db/migrate', () => {
  it('按序应用迁移并记录版本，重复执行为幂等', () => {
    ...
    for (const required of ['catalog_items', 'applications', 'application_materials', 'approval_logs']) {
