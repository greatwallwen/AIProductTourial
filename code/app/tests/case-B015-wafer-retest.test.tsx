...
const objects: CaseProjection[] = rows.map((payload,index)=>({caseId:"B015",objectId:`B015-${payload.wafer_id}`,state:"待复核",version:0,payload,updatedAt:"2026-07-26T07:00:00.000Z"}));
...
describe("WaferRetestWorkbench",()=>{
  ...
  it("filters observations, selects a row and toggles a retest channel",()=>{
    ...
    expect(onSelect).toHaveBeenCalledWith("B015-SECOM-0002");
