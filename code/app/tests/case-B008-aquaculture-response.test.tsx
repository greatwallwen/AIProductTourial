...
describe("AquacultureResponseWorkbench", () => {
  ...
  it("collects a field-operator id without invented team or ETA defaults", () => {
    ...
    expect(options).toMatchObject({
      ...
      idempotencyKey: `case-B008:${selected.objectId}:dispatch_field_check:v0`,
    });
  ...
  it("keeps role switching, reset, receipt and focused error recovery available", () => {
    ...
    rerender(<AquacultureResponseWorkbench {...props({ receipt: { ok: true, replayed: false, event: { eventId: "evt-08", caseId: "B008", objectId: selected.objectId, command: "dispatch_field_check", fromState: "待分派", toState: "现场取证中", actor: { id: "case08-field-dispatcher", role: "dispatcher" }, version: 1, occurredAt: "2026-07-25T08:00:00.000Z", evidenceIds: [] }, projection: { ...selected, state: "现场取证中", version: 1 } } })} />);
