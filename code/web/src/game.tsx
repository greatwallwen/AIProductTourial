...
const LENS_PAIRS = [
  { c: '子系统分解（案例 06）', d: '研发镜头 · 架构守护：routes 不写业务、依赖不许成环' },
  { c: 'RAG 评测台（案例 07）', d: '产品镜头 · eval loop：用评测集量化「答得准不准」' },
  { c: 'SDD 建造走查（案例 08）', d: '项目镜头 · governance：能不能发布靠可核对的关卡' },
  { c: '零售经营方案（案例 03）', d: '产品×项目：从数据到「现状→问题→动作→责任」闭环' },
  { c: '关系库架构（案例 05）', d: '研发镜头：把经营数据落成可查询的底座' },
