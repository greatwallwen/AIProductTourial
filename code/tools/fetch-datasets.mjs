...
const gens={
 ...
 aicourse_logistics_delivery:[700,['运单号','线路','城市','计划时效h','实际时效h','异常类型','是否扩城','责任方'],r=>{const plan=ri(r,12,72);const act=Math.max(6,plan+ri(r,-10,14));const late=act>plan+6;const ab=late||r()<0.12;return ['WB'+ri(r,1e5,9e5),'L'+ri(r,1,40),pick(r,['北京','上海','广州','成都','杭州','武汉','西安','沈阳']),plan,act,ab?(late?'超时':pick(r,['破损','改派','缺车'])):'',late&&r()<0.35?'是':'否',ab?pick(r,['干线','网点','客服']):''];}],
