...
const readme = J([`# ${TITLE}`, '',
  ...
  '## 这本书讲什么', '',
  `> **一句话**：AI 时代，你不再手动做每件事，而是**设计 Loop（自动运转的系统）、用 Skills、以验证/evals + 人在关口把关**。这套「操作模型」对 研发 / 产品 / 项目 三种角色是同一套；本书用它把三个角色统一起来，再用 ${defs.cases.length} 个真实行业案例（含 3 个 dogfood：书自己测试/评测/门禁自己）演示、验证。`,
  '>',
